...
// document.querySelectorAll(".nav-link").addEventListener("click", navitemclick);
// function navitemclick(){
//     for(var i=0; i<3;i++){
//     var numitemcolor=Math.round(Math.random()*7);

//     if(numitemcolor===0){
//         document.querySelectorAll(".nav-link")[i].style.color="red";
//     }
//     else if(numitemcolor===1){
//         document.querySelectorAll(".nav-link")[i].style.color="green";
//     }
//     else if(numitemcolor===2){
//         document.querySelectorAll(".nav-link")[i].style.color="white";
//     }
//     else if(numitemcolor===3){
//         document.querySelectorAll(".nav-link")[i].style.color="blue";
//     }
//     else if(numitemcolor===4){
//         document.querySelectorAll(".nav-link")[i].style.color="yellow";
//     }
//     else if(numitemcolor===5){
//         document.querySelectorAll(".nav-link")[i].style.color="pink";
//     }
//     else if(numitemcolor===6){
//         document.querySelectorAll(".nav-link")[i].style.color="brown";
//     }
...
function imgeffect() {
    ...
    document.querySelector(".why-img").style.height="93%";
}
...
function imgeffectrev(){
    ...
    document.querySelector(".why-img").style.height="90%";
